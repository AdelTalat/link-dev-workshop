  ...
  articles: Article [] = [
    {
        ...
        content: 'European stocks marched higher on Monday, alongside U.S. equity futures, driven by vaccine hopes, mergers and acquisitions news.The Stoxx Europe 600 index \r\n SXXP, \r\n +0.26%\r\nrose 0.5% after ending l… [+3119 chars]'
    },
    {
        sourceID: 1,
        id: 2,
        ...
        description: 'What a whirlwind of a Monday morning. Shortly after news broke that Microsoft is out of the picture in bidding for TikTok’s U.S. operations, and rumors began circulating that Oracle is the winner, China’s state broadcaster CGTN reported that ByteDance will no…',
        ...
        content: 'What a whirlwind of a Monday morning. Shortly after news broke that Microsoft is out of the picture in bidding for TikTok’s U.S. operations, and rumors began circulating that Oracle is the winner, Ch… [+1807 chars]'
    },
    {
        sourceID: 1,
        id: 3,
        ...
        urlToImage: 'https://s.yimg.com/uu/api/res/1.2/oad8t9TYgP.NMeECJjr1tg--~B/aD0zMzczO3c9NDk5MDtzbT0xO2FwcGlkPXl0YWNoeW9u/https://media-mbst-pub-ue1.s3.amazonaws.com/creatr-uploaded-images/2020-09/519a0930-f364-11ea-bffb-64367f2e833e',
        publishedAt: '2020-09-14T07:38:00Z',
        content: 'Stocks rose worldwide on Monday as AstraZeneca (AZN.L) and Oxford University confirmed plans to resume a leading coronavirus vaccine trial.\r\nInvestors welcomed the restart of the late-stage study, wh… [+2264 chars]'
    },
    {
        sourceID: 2,
        id: 4,
        ...
        description: '(Bloomberg Opinion) -- Don’t Get Too ComfortableIs it safe to put a price on technology again? After great excitement, the solemn date of Sept. 11 proved to be the first trading day of the month when the tech-heavy Nasdaq-100 didn’t move by more than 1%, in o…',
    ...
    },
    {
        ...
        description: 'Slabs are a “love it or hate it” type of thing. They are part of the Slab Culture originating in the ‘80s in Houston and, to this day, they’re still a big thing.',
        ...
        content: 'In fact, Slabs are so popular that more car owners seem to be itching to get in on the game. Usually, the cars used to make Slabs are cheaper, older American models, decked out in candy paint, fitted… [+1485 chars]'
    },
    {
        sourceID: 2,
        id: 6,
        ...
        content: 'U.S. stock index futures rose late Sunday, as a series of deals raised hopes that battered stocks would recover after the tech-heavy Nasdaq ended its worst week since March. As of midnight Eastern, D… [+682 chars]'
    },
    {
        sourceID: 5,
        id: 7,
        ...
        description: 'Zipline is partnering with Walmart for a new drone delivery operation in the US, the companies announced. Zipline’s launch and release system allows for on-demand delivery in less than an hour, and operating from a Walmart store, can service a 50-mile radius.',
        urlToImage: 'https://cdn.vox-cdn.com/thumbor/A2pSUEQx6OCBpuUoSh6_tm4g9dA=/0x129:1800x1071/fit-in/1200x630/cdn.vox-cdn.com/uploads/chorus_asset/file/21878290/Drone_Delivery_Shot_1.jpeg',
        publishedAt: '2020-09-14T04:01:00Z',
        content: 'Plans call for the program to start near Walmart headquarters in Arkansas early next year\r\nZipline\r\nZipline is partnering with Walmart for a new drone delivery operation in the US, the companies anno… [+1881 chars]'
    },
    {
        sourceID: 4,
        id: 8,
    ...
    },
    {
        ...
        urlToImage: 'https://www.gannett-cdn.com/presto/2020/09/14/PDTN/6c6b1149-f97c-41f8-b542-473619b1bcc7-AP20244723182709.jpg?crop=5279,2970,x0,y268&width=3200&height=1680&fit=bounds',
        publishedAt: '2020-09-14T00:45:02Z',
        content: 'A Delta Air Lines flight from Detroit to Los Angeles had to make a pre-liftoff detour back to the gate when a passenger refused to wear a mask.\r\nDelta Flight 201, scheduled to depart at 8:15 p.m. Sat… [+2444 chars]'
    },
    {
        sourceID:4,
        id: 11,
        ...
        description: 'World stocks rallied on Monday on hopes for a coronavirus vaccine after AstraZeneca resumed its phase-3 trial, but caution lingered before a host of central bank meetings this week.',
        ...
        content: 'LONDON (Reuters) - World stocks rallied on Monday on hopes for a coronavirus vaccine after AstraZeneca resumed its phase-3 trial, but caution lingered before a host of central bank meetings this week… [+3577 chars]'
    },
    {
        sourceID:4,
        id: 12,
        ...
        description: 'Recent fraud allegations have placed Nikola under an intense amount of scrutiny. The details behind Nikola\'s GM deal raises more doubts about Nikola\'s technology.',
        ...
        content: 'Nikola (NKLA) is establishing itself as one of the most volatile stocks in the market. After surging nearly 40% on news of the Nikola-General Motors (GM) deal, Nikola\'s stock quickly plunged as a res… [+5625 chars]'
    },
    {
        sourceID:5,
        id: 13,
        ...
        description: 'Use our calculator to estimate how much you, your family and your dependents could expect to receive with a second stimulus check, or with your first payment if you\'re still waiting for it to arrive.',
        urlToImage: 'https://cnet1.cbsistatic.com/img/F4ZpHvWRMSHICAPdaVMgaXRigDo=/1200x630/2020/08/04/24605e53-49eb-4e96-b84d-94e3800c90b1/calculate-calculator-amount-of-stimulus-check-2020-cash-money-phone-002.jpg',
        publishedAt: '2020-09-13T23:46:00Z',
        content: 'The CNET stimulus payment calculator can help you estimate how much money you could get from the IRS if a second check comes to be.\r\nSarah Tew/CNET\r\nIf a second stimulus check gets approved in 2020, … [+3336 chars]'
    },
    {
        sourceID:3,
        id: 14,
        ...
        urlToImage: 'https://i.guim.co.uk/img/media/a5d7127d69b12b5bf7adb02c93cbee7a69180d1e/0_180_3585_2153/master/3585.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=805d67edea7339a276948a05c77dfc9b',
        publishedAt: '2020-09-13T23:01:00Z',
        content: 'BP has called time on the worlds rising demand for fossil fuels after finding that demand for oil may have already reached its peak and faces an unprecedented decades-long decline.\r\nDemand for oil ma… [+4572 chars]'
    },
    {
        sourceID:1,
        id: 15,
    ...
    },
    {
        ...
        content: 'This Tesla Model 3 cost-of-ownership followup just premiered today. If you\'re in the market for a Model 3, another Tesla vehicle, or any EV for that matter, it\'s worth your time.\r\nThe Model 3 is Tesl… [+1850 chars]'
    },
    {
        sourceID:5,
        id: 17,
        ...
        urlToImage: 'https://www.gannett-cdn.com/presto/2020/09/13/USAT/22a46bbd-618b-49bb-935a-a3db6625f966-Screen_Shot_2020-09-13_at_4.37.57_PM.png?crop=737,415,x0,y0&width=737&height=415&format=pjpg&auto=webp',
        publishedAt: '2020-09-13T21:54:31Z',
        content: 'Peeps, the popular colored marshmallows shaped like baby chicks, won\'t come in Halloween or Christmas shapes this year due to the COVID-19 pandemic, the company said in a statement to USA TODAY. \r\nPe… [+1313 chars]'
    },
    {
        sourceID:3,
        id: 18,
        ...
        content: 'Late in the week, gold jumped as the dollar weakened after the European Central Bank kept its policy unchanged and U.S. jobless claims held at high levels, dimming hopes of a quick economic recovery … [+2257 chars]'
    },
    {
        sourceID:5,
        id: 19,
